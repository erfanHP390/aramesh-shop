  ...
  return (
    <>
           <p className={styles.tag}>قهوه</p>
                ...
                <section>
                    <p>ماریا پیکو-پرز، سرپرست تیم تحقیق  از دانشگاه Jaume I ، در بیانیه‌ای درباره این یافته‌ها گفت : به عبارت ساده، شرکت کنندگان در این تحقیق بعد از نوشیدن قهوه برای انجام فعالیت هایشان آماده تر بودند و هوشیار آنها نسبت به محرک‌های خارجی بیشتر شده بود.</p>
