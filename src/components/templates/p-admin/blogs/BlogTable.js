  ...
  return (
    <>
      ...
      {showModal && selectedBlog && (
        <Modal title={`جزئیات مقاله ${selectedBlog.title}`} hideModal={hideModal}>
          <div className={styles.modal_product}>
            <div className={styles.modal_product_header}>
              <h2 className={styles.modal_product_title}>{selectedBlog.title}</h2>
            </div>
            ...
            <div className={styles.modal_product_content}>
              ...
              <div className={styles.modal_product_meta}>
                  <div className={styles.modal_product_meta_item}>
                    <span className={styles.modal_product_meta_label}>نویسنده</span>
                ...
                <div className={styles.modal_product_meta}>
                  <div className={styles.modal_product_meta_item}>
                    <span className={styles.modal_product_meta_label}>تاریخ ایجاد</span>
                    <span className={styles.modal_product_meta_value}>
                      {new Date(selectedBlog.createdAt).toLocaleDateString("fa-IR")} 
                    </span>
                  </div>
                </div>
                ...
                <div className={styles.modal_product_meta}>
                  <div className={styles.modal_product_meta_item}>
                    <span className={styles.modal_product_meta_label}>آخرین بروزرسانی</span>
                    <span className={styles.modal_product_meta_value}>
                    {new Date(selectedBlog.updatedAt).toLocaleDateString("fa-IR")} 
                    </span>
                  </div>
                </div>
                ...
                <div className={styles.modal_product_meta}>
                  <div className={styles.modal_product_meta_item}>
                    <span className={styles.modal_product_meta_label}>تیتر</span>
                    <span className={styles.modal_product_meta_value}>
                      {selectedBlog.titr} 
                    </span>
                  </div>
              ...
              <div className={styles.modal_product_description}>
                <h3 className={styles.modal_product_description_title}>چکیده</h3>
              ...
              <div className={styles.modal_product_description}>
                <h3 className={styles.modal_product_description_title}>مقاله</h3>
                <p className={styles.modal_product_description_text}>
