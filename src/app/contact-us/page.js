...
export const metadata = {
  ...
  description:
    "تماس مستقیم با فروشگاه تخصصی قهوه آرامش | آدرس شعب تهران و مشهد | شماره تلفن: 021-11111122 | پشتیبانی 24 ساعته | پاسخگویی به سوالات درباره خرید قهوه اسپشیالیتی",
  keywords: [
    "تماس با آرامش",
    "آدرس کافی شاپ آرامش",
  ...
  openGraph: {
    ...
    description:
      "راه‌های ارتباطی با فروشگاه تخصصی قهوه آرامش - شعب تهران و مشهد",
    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <p className={styles.introText}>
          ما 24 ساعته آماده پاسخگویی به سوالات شما درباره قهوه‌های اسپشیالیتی
          هستیم
        </p>

        <main className={styles.maps}>
          <section>
            <Map position={[35.7975, 51.423]} center={[35.7975, 51.423]}>
              ...
              <p>
                <a href="tel:+982111111122" className={styles.phoneLink}>
                  021-11111122
                </a>
              </p>
          ...
          <section>
            <Map position={[36.306, 59.56]} center={[36.306, 59.56]}>
              <span> فروشگاه ما</span>
              <h2>آدرس فروشگاه حضوری آرامش (شعبه دو)</h2>
              <p>
                شعبه دو - مشهد ، روبروی پارک ملت ، خیابان گلشن ، نبش کوچه گلشن
                هشتم
              </p>
              <p>
                <a href="tel:+985137121154" className={styles.phoneLink}>
                  051-37121154
                </a>
              </p>
              <Link href="/about-us" className={styles.aboutLink}>
