...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    description: `${
      product.shortDesc ||
      `خرید ${product.name} - ${product.smell} با کیفیت عالی`
    } | قیمت: ${product.price.toLocaleString()} تومان | وزن: ${
      product.weight
    } گرم`,
    keywords: [
      product.name,
      ...
      images: [
        {
          url:
            product.img ||
            "https://aramesh-coffee.com/images/product-default.jpg",
          width: 800,
          height: 600,
          alt: product.name,
        },
  ...
  return (
    <div className={styles.container}>
      ...
      <div data-aos="fade-up" className={styles.contents}>
        ...
        <MoreProducts
          relatedProducts={JSON.parse(JSON.stringify(filteredRelatedProducts))}
        />
      </div>
      <Footer />
    </div>
